...
class trainingData(object):
    ...
    def load(fout, start_string, end_string, delta):
        """
        ...
        mergedTrainingData = fg.mergeDataframes(trainDataWithFeatures, index)
    ...
    def loadFromWeb(fout, start_string, end_string):
        """
    ...
    def returnDataForClassification(start_test):
        """
